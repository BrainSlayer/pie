...
#define RTL838X_ICTL6_IRQ	(RTL838X_IRQ_CPU_BASE + 7)
...
#define RTL930X_SMI_GLB_CTRL		(0xC200)
#define RTL930X_SMI_POLL_CTRL		(0xC280)

// BUG: Guessed
#define RTL9302_SMI_GLB_CTRL		(0xCA00)
#define RTL9302_SMI_POLL_CTRL		(0xca90)

#define RTL930X_SMI_ACCESS_PHY_CTRL_0	(0xC338)
#define RTL930X_SMI_ACCESS_PHY_CTRL_1	(0xC33C)
#define RTL930X_SMI_ACCESS_PHY_CTRL_2	(0xC340)
#define RTL930X_SMI_ACCESS_PHY_CTRL_3	(0xC344)
...
#define RTL930X_IMR_GLB			(0xBE24)
#define RTL930X_IMR_PORT_LINK_STS_CHG	(0xBE28)
#define RTL930X_ISR_GLB			(0xBE50)
#define RTL930X_ISR_PORT_LINK_STS_CHG	(0xBE58)
