...
static int c0_compare_int_pending(void)
{
	...
	int v = (read_c0_cause() >> cp0_compare_irq_shift) & (1ul << CAUSEB_IP);
	pr_info("-> %d\n", v);
	return v;
}
...
{
	pr_info("In %s: base %d, cc_irq: %d\n", __func__, MIPS_CPU_IRQ_BASE, cp0_compare_irq);
